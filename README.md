...
| 플러그인 | 설명 | 명령어 | 버전 |
|---------|------|--------|------|
| `cruise` | 이슈 단위 개발 사이클 자동화 — 플랜·구현·검사·커밋·머지·PR·리뷰·회고 | `/cruise:plan`, `/cruise:build`, `/cruise:check`, `/cruise:commit`, `/cruise:merge`, `/cruise:pr`, `/cruise:review`, `/cruise:result` | 0.5.0 |
