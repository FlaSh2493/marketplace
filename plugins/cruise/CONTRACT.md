...
```markdown
## 요구사항
- [x] R1: 목록을 카드 그리드로 렌더 (모바일 1열 / 태블릿 3열 / 데스크톱 4열)
- [ ] R2: 커서 기반 무한 스크롤
- [x] R3: 빈 목록 시 안내 문구 (수동확인)
- [ ] R4: 정렬 옵션 (철회: 이번 스코프 제외)
```
...
- 2026-08-20: R6 추가 — 카테고리 필터 칩 ("카테고리별로 걸러지게")
- 2026-08-20: R7 추가 (인자: "필터 칩 키보드 탐색도 되게")
- 2026-08-20: R1 개정 — 태블릿 3열·데스크톱 4열 ("2열은 비어 보이네")
- 2026-08-20: R4 철회 — 이번 스코프 제외 ("정렬은 이번엔 빼자")
```
