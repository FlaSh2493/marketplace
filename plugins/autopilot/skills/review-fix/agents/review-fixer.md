...
```json
{
  "applied":   [{"id": 123, "path": "src/foo.ts", "line": 42, "severity": "important", "summary": "캐싱 로직 추가"}],
  "skipped":   [{"id": 124, "path": "src/bar.ts", "line": 10, "severity": "suggestion", "reason": "구현 맥락상 의도적 패턴"}],
  "dismissed": [{"id": 125, "path": "src/baz.ts", "line": 5, "severity": "nitpick", "reason": "스타일 선호도"}],
  "fixed_files": ["src/foo.ts"],
  "check_result": {"passed": ["lint", "check-types", "test"], "failed": [], "fixed_files": [], "skipped": []}
}
```
